...
void SceneManager::setupScene()
{
	...
	obj = new Sprite;
	obj->setPosition(glm::vec3(500.0f, 130.0f, 0.0));
	obj->setDimension(glm::vec3(92.75f, 100.25f, 1.0f)); //note que depois podemos reescalar conforme tamanho da sprite
	obj->setShader(shader);
	objects.push_back(obj); //adiciona o primeiro obj

	obj = new Sprite;
	obj->setPosition(glm::vec3(300.0f, 130.0f, 0.0));
	obj->setDimension(glm::vec3(140.0f, 140.0f, 1.0f)); //note que depois podemos reescalar conforme tamanho da sprite
	obj->setShader(shader);
	objects.push_back(obj); //adiciona o primeiro obj

	unsigned int texID;
	
	texID = loadTexture("textures/background.jpg");
