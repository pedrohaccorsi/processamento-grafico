...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		400.0f, 100.0f, 0.0f, 1.0, 0.0, 0.0, //Superior esquerdo
		200.0f, 300.0f, 0.0f, 0.0, 1.0, 0.0, //Inferior esquerdo
	    600.0f, 300.0f, 0.0f, 0.0, 0.0, 1.0, //Superior esquerdo
	   
	   
		200.0, 300.0f, 0.0f, 1.0, 1.0, 0.0,
	    600.0f, 300.0f, 0.0, 1.0, 0.0, 1.0,  //Inferior esquerdo
	    400.0f, 500.0f, 0.0f, 0.0, 1.0, 1.0
	};
