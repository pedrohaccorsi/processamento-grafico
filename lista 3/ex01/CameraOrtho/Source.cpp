...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//criando o quadrado de 2 triângulos no canto direito sem transformação nenhuma
		model = glm::mat4(1);
		...
		glBindVertexArray(0);
		//fim criando o quadrado de 2 triângulos no canto direito  sem transformação nenhuma
		 

		//criando o quadrado de 2 triângulos no canto caídos na diagonal
		model = glm::mat4(1);
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.0f));
		model = glm::rotate(model, (GLfloat)glm::radians(60.0), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		glDrawArrays(GL_LINE_LOOP, 0, 6);
		glBindVertexArray(0);
		//fim criando o quadrado de 2 triângulos no centro sem transformação nenhuma
		 


		//criando o quadrado de 2 triângulos rotacionando
		model = glm::mat4(1);
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.0f));
		model = glm::translate(model, glm::vec3(1.5f, 0.0f, 0.0f));
		...
		glDrawArrays(GL_LINE_LOOP, 0, 6);
		glBindVertexArray(0);
		// fim criando o quadrado de 2 triângulos
